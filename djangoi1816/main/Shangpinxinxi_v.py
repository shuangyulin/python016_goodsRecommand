...
def shangpinxinxi_page(request):
    ...
    if request.method in ["POST", "GET"]:
        ...
        msg['data']['pageSize']  =shangpinxinxi.page(shangpinxinxi, shangpinxinxi, req_dict, request)
...
def shangpinxinxi_autoSort2(request):
    ...
    if request.method in ["POST", "GET"]:
        ...
        L = []
        cursor.execute("select * from shangpinxinxi where shangpinleixing in ('%s"%("','").join(leixing)+"') union all select * from shangpinxinxi where shangpinleixing not in('%s"%("','").join(leixing)+"')")
...
def shangpinxinxi_alipay(request):
    if request.method in ["POST", "GET"]:
        ...
        order_string = alipay.api_alipay_trade_page_pay(
            ...
            return_url='http://localhost:8080/djangoi1816/shangpinxinxi/notify',
            #notify_url=''
        )
...
def shangpinxinxi_notify(request):
    if request.method in ["POST", "GET"]:
        ...
        return redirect('http://localhost:8080/djangoi1816/admin/dist/index.html#/shangpinxinxi')
